<div class="col-xl-8">
    <div class="card pd-20 pd-sm-40 form-layout form-layout-4">
        ...
        <p class="mg-b-20 mg-sm-b-30">Data Nopung Cantik</p>
        <form name="kategoriform" enctype="multipart/form-data" id="selectForm" method="post" action="<?php echo $form_action; ?>">
            <div class="row">
                ...
                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                    <input class="form-control" id="nama" name="lcnopungbagus" type="text"
                           value='<?php echo set_value('lcnopungbagus', isset($data['lcnopungbagus']) ? $data['lcnopungbagus'] : ''); ?>'>
                </div>
            </div><!-- row -->
            <div class="row">
