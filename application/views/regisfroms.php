...
<html>
    ...
    <script type="text/javascript">
        ...
        var lcnopungbagus=document.forms["regisform"]["lcnopungbagus"].value;
        alert("nopung :"+lcnopungbagus);
       ...
       var lckodepos=document.forms["regisform"]["lckodepos"].value;
        ...
        var transfer=document.forms["regisform"]["transfer"].value;
        if (transfer==null || transfer==""){
          alert("Silahkan upload photo bukti transfer anda !");
          return false;
        };
     }
</script>
