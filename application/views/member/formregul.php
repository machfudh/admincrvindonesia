<div class="col-xl-8">
    <div class="card pd-20 pd-sm-40 form-layout form-layout-4">
        ...
        <p class="mg-b-20 mg-sm-b-30">Tidak Ada Biaya </p>
        <form name="regisform" enctype="multipart/form-data" id="selectForm" method="post" onsubmit="return validasi()" action="<?php echo $form_action; ?>">
              <div class="row">
                <label class="col-sm-4 form-control-label">No Pung  : <span class="tx-danger">*</span></label>
                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                    <input class="form-control" id="nama" name="lcnopung" type="text"  disabled="true"
            ...
            <div class="row">
                ...
                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                    <input class="form-control" id="nama" name="lcemail" type="text" placeholder="harus di isi ( ex:xxxx@yyy.com )" disabled="true"
            ...
            <input type="hidden" name="lcidx"  value="<?php echo set_value('lcidx', isset($data['lcidx']) ? $data['lcidx'] : ''); ?>" />
