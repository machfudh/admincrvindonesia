    ...
    <div class="card pd-20 pd-sm-40 form-layout form-layout-4">
        ...
        <form name="kategoriform" enctype="multipart/form-data" id="selectForm" method="post" action="<?php echo $form_action; ?>">
            ...
            <div class="row">
                ...
                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                    <input class="form-control" id="nama" name="lcuserlogin" type="text" placeholder="User Login" disabled="true"
            ...
            <div class="row">
                ...
                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                    <input class="form-control" id="nama" name="lcuserpass" type="password" placeholder="User Password"
