        ...
        if ($numRow > 0) {
            ...
            foreach ($mDatalist as $sDataList) {
                ...
                $this->table->add_row(anchor($this->tabel . '/action/edit/' . $sDataList->id_member, $sDataList->nopung=null?" ":$sDataList->nopung), $sDataList->nama,$sDataList->namachapter,$sDataList->nopolisi,$sDataList->provinsi,$sDataList->kabupaten, 
                  ...
                  $this->table->add_row($sDataList->nopung=null?" ":$sDataList->nopung, $sDataList->nama,$sDataList->namachapter,$sDataList->nopolisi,$sDataList->provinsi,$sDataList->kabupaten,
                          anchor("new" .$this->tabel . '/action/edit/' . $sDataList->id_member, '<i class="icon ion-archive"></i>', array('class' => "edit-row", 'data-original-title' => 'Edit')) . "&nbsp&nbsp&nbsp" 
                  );
                  } 
            }
