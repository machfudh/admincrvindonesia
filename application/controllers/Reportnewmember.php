 ...
 * @author user
 */
class Reportnewmember extends CI_Controller {
...
//        }
    ...
    var $limit = 10;
    var $title = 'Report New Member by Active Date';
    var $linkweb = 'barang';
...
//        echo $tanggalReport;
        ...
        $mDatalist = $this->crudmodel->list_report('v_newmember', $this->limit, $offset, $dawal, $dakhir, $kurir, $shipp)->result();
        $numRow = $this->crudmodel->count_report('v_newmember', $dawal, $dakhir, $kurir, $shipp)->num_rows();
        if ($numRow > 0) {
...
//                }
        ...
        $data['link'] = array('link_add' => anchor('reportexcel/cetakexcel/001', '<div><i class="icon ion-document-text"></i></div>', 'class="btn btn-outline-success btn-icon mg-r-20"'),
